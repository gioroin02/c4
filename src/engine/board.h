#ifndef C4_ENGINE_BOARD_H
#define C4_ENGINE_BOARD_H
...
pxb8
c4GameBoardGet(C4GameBoard* self, pxiword col, pxiword row, pxuword* value);

pxuword
c4GameBoardGetOr(C4GameBoard* self, pxiword col, pxiword row, pxuword value);
